...
module.exports = {  //Aquí se encuentra toda la configuración de lo que va a suceder. Modulo para exportar.
    entry: './app/config/Initial.js', //Punto de entrada con su dirección.Aquí vive el código inicial y de aquí parte al desarrollo.
    ...
    module: { //Se crea un modulo con las reglas necesarias que vamos a utilizar.
        rules: [    //Reglas
            {   // Estructura de Babel
                ...
                exclude: [/node_modules/,/server/], //Excluimos la carpeta de node modules
                use: {
        ...
        new HtmlWebpackPlugin([    //Permite trabajar con los archivos HTML
            {
                ...
                template: './index.html',    //Dirección donde se encuentra el template principal
