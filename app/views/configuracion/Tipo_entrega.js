                        ...
                        <form name="save">
                            <div class="modal-body">
                                <div class="row"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><input type="checkbox" name="fl_reparto" /> Entrega con reparto</label>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><input type="checkbox" name="fl_clave_entrega" /> Requiere clave para entrega</label>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><input type="checkbox" name="fl_direccion_destinatario" /> Requiere dirección del destinatario</label>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><input type="checkbox" name="fl_direccion_remitente" /> Requiere dirección del remitente</label>                                            
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><input type="checkbox" name="fl_persona_contacto" /> Requiere persona de contacto</label>                                            
                                        </div>
                                    </div>
