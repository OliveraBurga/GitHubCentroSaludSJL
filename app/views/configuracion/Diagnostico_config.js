...
let Componente = {
                                        ...
                                        <div class="form-group">
                                            <label>Tipo </label>
                                                <select name="tipo"  class="form-control select2">
                                                    ...
                                                    <option value="INTERVENCION QUIRURGICA">INTERVENCION QUIRURGICA</option>
                                                </select>
                                        </div>
                                    </div>
                                </div>                              
    ...
    datatable: function() {
        ...
        this.table = DOM.find('table[name="registros"]').DataTable({
            ajax:BASE_API + 'configuracion/diagnostico_config',
            columns: [{
                    title: 'ACCIÓN',
                    defaultContent: ``,                    
    ...
    delete: function(row) {
        ...
        form.find('div[name="texto"]').text(data.nombre + ' - ' + data.tipo);
    ...
    submit: function() {
        ...
        axios({
            method: 'post',
            url: BASE_API + 'configuracion/diagnostico_config/' + this.action_submit,
            data: formData
        })
