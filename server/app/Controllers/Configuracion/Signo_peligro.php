...
use App\Models\Configuracion\Signo_peligro_model;
use App\Models\Configuracion\Permiso_model;
use App\Models\Image_model;

class Signo_peligro extends BaseController
{
	public function __construct()
	{
		$this->Signo_peligro = new Signo_peligro_model();
 
	}

	public function get_select()
	{
		$response = $this->Signo_peligro->select('tipo, signo as text')->findAll();
